...
Buka terminal (Git Bash/CMD), lalu masuk ke folder: backend

Aktifkan virtual environment. (Jika Git Bash ketik: source venv/bin/activate | Jika CMD ketik: venv\Scripts\activate.bat)

Jalankan server dengan mengetik perintah: python manage.py runserver
...
Masuk ke folder: TEMPLATE-REACT

Ketik perintah: npm install (untuk mengunduh dependensi).

Ketik perintah: npm run dev (untuk menyalakan web).

Buka link localhost:5173 yang muncul di terminal lewat browser Anda.
